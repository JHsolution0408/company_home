...
아날로그 정보를 디지털화하고, 설비 고장을 사전에 예측하여 운영 효율의 정점을 실현합니다.
...
<td id=box1>
    <table>
    <tr>
        <td width="535px"> <img src="/images/solutions/card_ai1.png" style="border-radius:5%"> </td>
    </tr>
    <tr>
...
<td id=box2>
    <table>
    <tr>
        <td width="535px"> <img src="/images/solutions/card_ai2.png" style="border-radius:5%"></td>
    </tr>
    <tr>
...
<td id=box3>
    <table>
    <tr>
        <td  width="540px"><img src="/images/solutions/card_ai3.png" style="border-radius:5%"></td>
    </tr>
    <tr>
