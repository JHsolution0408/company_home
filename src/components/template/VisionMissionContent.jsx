    ...
    <div className={styles.wrapper}>
      ...
      <section>
        <SectionTitle
          ...
          description={'고객과 함께 최적화 여정을 시작하고 성공적으로 완수해 나가겠습니다.'}
        />
        ...
        <div className={styles.flexBox}>
          <div className={styles.valueCard}>
            <div className={styles.valueHeader}>
              ...
              <img src="/images/about/mission-3.png" alt="미션 3" />
            </div>
            <h3 className={styles.valueTitle}>
              고객의 성공을 위한 정략적 최적화
            </h3>
            <p className={styles.valueDescription}>
              우리 기술은 고객의 이익으로 이어져야 합니다. JHAION 엔진으로 운영 효율을 극대화 하고 에너지 비용과 탄소 배출을 동시에 낮춰 고객의 경쟁력을 수치로 증명합니다.
            </p>
          </div>
          ...
          <div className={styles.valueCard}>
            <div className={styles.valueHeader}>
              ...
              <img src="/images/about/mission-4.png" alt="미션 4" />
            </div>
            <h3 className={styles.valueTitle}>
      ...
      <section>
        <SectionTitle
          title={(
            <>
              기술혁신을 이끄는 <span>핵심 가치</span>
            </>
          )}
          description={'AI 기반의 독보적인 기술 역량으로 지속 가능한 미래를 선도하는 글로벌 파트너가 되겠습니다.'}
        />
